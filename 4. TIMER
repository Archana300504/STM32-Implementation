...
/*	Private variables
*/
TIM_HandleTypeDef htim6; UART_HandleTypeDef huart2;
/* USER CODE BEGIN PV */
...
static void MX_USART2_UART_Init(void); static void MX_TIM6_Init(void);
/*	USER CODE BEGIN PFP */	
/*	USER CODE END PFP */	
/*
...
/* USER CODE END TIM6_Init 1 */ htim6.Instance = TIM6; htim6.Init.Prescaler = 16000-1;
htim6.Init.CounterMode = TIM_COUNTERMODE_UP; htim6.Init.Period = 1000-1;
